...
Human oversight context is the maximum of mean consequence-of-error and mean health-and-safety responsibility, on the source’s 0–5 scale. It is presented separately, not subtracted from the score and not called a validated complementarity adjustment. Responsibility for outcomes and face-to-face discussion ratings are retained in the evidence.
