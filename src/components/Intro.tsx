  ...
  return (
    <section className="intro-screen" id="top" aria-labelledby="intro-title">
      <div className="intro-copy">
        ...
        <p className="intro-byline"><AnimatedText text="An interactive view of employment, opportunity, and technological change." delay={320} duration={390} /></p>
        <p className="intro-date"><AnimatedText text="SEPTEMBER 2026" delay={360} duration={290} /></p>
